  ...
  <div class="container">
    <div class="row ">
      <div class="col-md-8 mx-auto ajouter py-5">
        ...
        <p class="lead mb-4 text-light text-center">Veuillez attendre la fin des téléchargement pour continuer !</p>
...
<!--            <div class="form-group"> <label class="lead text-light">Prix en euros :</label>
          ...
          <div class="form-group"><label class="lead form-control-label text-light">Téléchargement des images du carousel :<br></label>
          ...
          <div class="form-group">
              <label class="lead form-control-label text-light">Télécharchement du modèle 3D :</label>
